...
- How can you create virtual DOM nodes with JSX?
  ...
  2. By defining XML syntax in a JavaScript file.
  3. By calling the renderAsHTML method available in React.
  4. By adding a JSX attribute to the HTML in your HTML documents. <br></br>
...
- Is it okay for a component to have multiple responsibilities?
  ...
  3. It does not matter as long as the code works. <br></br>
